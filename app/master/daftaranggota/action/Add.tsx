...
function Add({ reload }: { reload: Function }) {
    ...
    const [tanggalDaftar, setTanggalDaftar] = useState(new Date().toISOString().slice(0, 10));
    ...
    function clearForm() {
        ...
        setEmail('')
        setHp('')
        setTanggalDaftar(new Date().toISOString().slice(0, 10));
    ...
    const handleSubmit = async (e: SyntheticEvent) => {
        ...
        try {
            ...
            const xxx = await axios.post(`/api/daftaranggota`, formData, {
                headers: {
            ...
            <Modal
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <Modal.Body>
                        ...
                        <div className="row">
                            <div className="mb-3 col-md-12">
                                <label className="col-sm-6 col-form-label">Tgl.Daftar </label>
                                <input
                                    
                                    required
                                    type="date"
                                    className="form-control"
                                    value={tanggalDaftar} onChange={(e) => setTanggalDaftar(e.target.value)}
                                />
                            </div>
                        </div>
                    </Modal.Body>
